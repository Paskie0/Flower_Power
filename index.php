        ...
        <div class="navbar-end">
            ...
            <div class="dropdown dropdown-end drop-shadow-lg">
                ...
                <div class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box">
                    <form action="./functions/login.php" method="post" tabindex="0" id="login" autocomplete="off">
                    ...
                    <form action="./functions/register.php" method="post" tabindex="0" id="register" class="hidden">
