        ...
        <div class="dropdown dropdown-end drop-shadow-lg ml-4 z-10">
            ...
            <div class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box flex items-center">
                <form action="./functions/add-product.php" method="post" tabindex="0" id="login" autocomplete="off">
                    ...
                    <button type="submit" class="btn btn-primary btn-wide btn-sm mt-4 h-full no-animation">Toevoegen</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
        ...
        ?>
                <div class="product-item cursor-pointer">
                    <div class="block bg-gray-800 rounded-lg shadow-md p-4">
